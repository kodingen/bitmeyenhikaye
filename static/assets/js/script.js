...
/* --------------------------------------------------------
        ...
        --------------------------------------------------------   */
(function() {
    $('<div class="color-picker"><a href="#" class="handle"><i class="icofont icofont-color-bucket"></i></a><div class="settings-header"><h3>Tema Rengi Seç</h3></div><div class="section"><h3 class="color">Mevcut Tema Renkleri:</h3><div class="colors"><a href="#" class="color-1" ></a><a href="#" class="color-2" ></a><a href="#" class="color-3" ></a><a href="#" class="color-4" ></a><a href="#" class="color-5"></a><a href="#" class="color-6"></a></div></div></div>').appendTo($('body'));
})();
...
$(".color-1").click(function() {
	...
	localStorage.setItem("temaRengi", "color-1.css");
    return false;
});
$(".color-2").click(function() {
	$("#color").attr("href", "/static/assets/css/color/color-2.css");
   localStorage.setItem("temaRengi", "color-2.css");
    return false;
});
$(".color-3").click(function() {
	$("#color").attr("href", "/static/assets/css/color/color-3.css");
    localStorage.setItem("temaRengi", "color-3.css");
    return false;
});
$(".color-4").click(function() {
	 $("#color").attr("href", "/static/assets/css/color/color-4.css");
    localStorage.setItem("temaRengi", "color-4.css");
    return false;
});
$(".color-5").click(function() {
    $("#color").attr("href", "/static/assets/css/color/color-5.css");
    localStorage.setItem("temaRengi", "color-5.css");
    return false;
});
$(".color-6").click(function() {
    $("#color").attr("href", "/static/assets/css/color/color-6.css");
	localStorage.setItem("temaRengi", "color-6.css");
    return false;

});

document.addEventListener('DOMContentLoaded', function () {
	if (localStorage.getItem("temaRengi") !== null) {
		$("#color").attr("href", "/static/assets/css/color/" + localStorage.getItem("temaRengi"));
		return false;
	}
	else
		$("#color").attr("href", "/static/assets/css/color/color-1.css");
